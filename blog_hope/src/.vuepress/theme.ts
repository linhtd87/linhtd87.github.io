...
import { viNavbar, enNavbar, zhNavbar } from "./navbar/index.js";
import { viSidebar, enSidebar, zhSidebar } from "./sidebar/index.js";
...
export default hopeTheme({
  hostname: "https://linhtd128.github.io",

  author: {
    name: "Mr.Linh",
    url: "http://linhtd.site",
  },
  ...
  locales: {
    "/": {
      ...
      footer: "một dev vui tính, một người đam mê chạy bộ, chụp ảnh và kiêm bố của 2 đứa con gái",
